...
public class Game extends Canvas implements Runnable, EventListener {
	...
	public Game() {
		...
		player = new Player("Celtic", playerSpawn.x(), playerSpawn.y(), key);
		level.add(player);
		...
		//addKeyListener(key);  <- Was used by Java but discontinued in the version I use
	...
	public void update() {
		key.update();
		frame.requestFocus(); // Added by Me maybe necessary to add at the bottom of method
		uiManager.update();
	...
	public void render() {
		...
		uiManager.render(g);
		//	g.drawString("x: " + player.x +  ", y: " + player.y, 450, 450);
